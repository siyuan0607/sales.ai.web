...
<div class="app-container">
    ...
    <el-dialog :visible="dialogVisible" :title="formTitle" width="600" :before-close="closeDialog">
        <el-form :model="productEditorForm" ref="productEditorForm" @submit="handleSubmit" :rules="formRules" label-width="100px">
            ...
            <el-form-item label="销售卖点" prop="sales_point">
                <el-input v-model="productEditorForm.sales_point" type="textarea" :rows="3" name="sales_point" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="销售策略" prop="sales_strategy">
                <el-input v-model="productEditorForm.sales_strategy" type="textarea" :rows="3" name="sales_strategy" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="产品政策" prop="policy">
                <el-input v-model="productEditorForm.policy" name="policy" type="textarea" :rows="3" autocomplete="off"></el-input>
            </el-form-item>
            ...
            this.$refs.productEditorForm.validate(valid => {
                if (valid) {
                    if (this.productEditorForm.uid === "") {
                        addProduct(this.productEditorForm).then(response => {
                        ...
                        updateProduct(this.productEditorForm).then(response => {
                            this.dialogVisible = false
                            this.$message({
                                message: response.msg,
                                type: 'success'
